...
public class DBHelper {
    ...
    public void updateNotesRecord(int id, String title, String date, String tags, String description) throws SQLException {
    ...
    public void insertNotesRecord(String title, String date, String tags, String description) throws SQLException {
    ...
    public void deleteNotesRecord(int id) throws SQLException{
        query.update("DELETE FROM tblnotes WHERE id = " + id);
    }
    
    public ResultSet displayAllRecords() throws SQLException{
        return query.execute("SELECT * FROM tblnotes");
    }
    
    public ResultSet searchNotesRecordById(int id) throws SQLException{
        return query.execute("SELECT * FROM tblnotes WHERE id = " + id);
    }
    public ResultSet searchNotesRecordByTag(String tags) throws SQLException{
        return query.execute("SELECT * FROM tblnotes where tags = " + tags);
    }
