 ...
 */
public class AddNewNotes extends javax.swing.JFrame {
    ...
    private void btnSaveMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnSaveMouseClicked
        ...
        try{
            ...
            dbHelper.insertNotesRecord(title,date,tags,description);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AddNewNotes.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AddNewNotes().setVisible(true);
            }
        });
    }
